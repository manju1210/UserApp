...
class _SignUpWidgetState extends State<SignUpWidget> {
  ...
  FocusNode _gstFocus = FocusNode();
  FocusNode _addressFocus = FocusNode();
  FocusNode _pincodeFocus = FocusNode();
  FocusNode _firmNameFocus = FocusNode();
  ...
  addUser() async {
    if (_formKey.currentState.validate()) {
      ...
      String _gstNo = _gstController.text.trim();
      String _firmName = _firmNameController.text.trim();
      ...
      if (_firstName.isEmpty) {
      ...
      else if (_gstNo.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text("GST number must be required"),
          backgroundColor: Colors.red,
        ));
      }
      else if (_firmName.isEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text("Firm name must be required"),
          backgroundColor: Colors.red,
        ));
      }
        ...
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text("Pincode must be required"),
          backgroundColor: Colors.red,
        ));
      }
        ...
        register.gstNo = _gstController.text;
        register.firmName = _firmNameController.text;
        register.address = _addressController.text;
        register.pincode = _pincodeController.text;
        await Provider.of<AuthProvider>(context, listen: false).registration(register, route,context);
      }
    } else {
